...
# Options: Average distance over multiple paths
# Options: Average distance over multiple P hat.

# Data generation:
# option 1: Sampling as usual
# option 2: Sampling using friends of friends